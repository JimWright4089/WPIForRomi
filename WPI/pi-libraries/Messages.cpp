...
void DS_Status_Message::SetAll(byte all)
{
    mData[ALL_BYTE_LOC] = all;
}
...
byte DS_Status_Message::GetAll()
{
    return mData[ALL_BYTE_LOC];
}
...
{
    return (int16_t*)&mData[ANALOG_BYTE_LOC];
}
