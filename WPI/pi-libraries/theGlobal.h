...
class theGlobal : tGlobal
{
   tLEDs mLEDs;
public:
   tSystemInterface* getSystemInterface();
   void writeLEDs(tLEDs value, tRioStatusCode *status);
   void writeLEDs_Comm(unsigned char value, tRioStatusCode *status);
   void writeLEDs_Mode(unsigned char value, tRioStatusCode *status);
   void writeLEDs_RSL(bool value, tRioStatusCode *status);
   tLEDs readLEDs(tRioStatusCode *status);
   unsigned char readLEDs_Comm(tRioStatusCode *status);
   unsigned char readLEDs_Mode(tRioStatusCode *status);
   bool readLEDs_RSL(tRioStatusCode *status);
